...
class Calendar extends Component {
    ...
    render() {
        return (
            <div>
                <h2>A basic timeline. You can move and zoom the timeline, and select items.</h2>
                <Timeline {...basicExample} />

                <h2>Groups example. Dynamically add, update or remove both items and groups via the DataSet.</h2>
                <Timeline
                    {...groupsExample}
